...
| GraphQL role gates: Customer create/update/submit; Reviewer/TenantAdmin review lifecycle; authenticated `cases` / `case` | Document upload / remaining domain queries |
