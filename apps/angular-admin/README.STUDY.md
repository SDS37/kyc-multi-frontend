...
- Mixing side effects into mappers — keep [functional style at the function level](../../docs/frontend-code-standards.md#functional-style--purity-all-frontends) (`*.mappers.ts` pure functions; I/O in services)
