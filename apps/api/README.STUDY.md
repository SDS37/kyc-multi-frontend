...
- **After MVP:** still one deployable. Redis / MF host / user invite/list only with triggers in [beyond-mvp.md](../../docs/beyond-mvp.md). Angular, React, and Vue reports are on `main`.
