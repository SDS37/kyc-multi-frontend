...
Approve/reject/list/detail/upload/download-metadata are **done**. Missing: audit trail, richer comments. Do not invent a second visibility mechanism in the Angular app that contradicts `CaseVisibility`.
